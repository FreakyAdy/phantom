...
| **`test_16`** | 2026-09-18 | `PHANTOM-v2-Colab-Harness` | **EAGLE-3 + MoE Prefetch Correlation** | Q4_K_M | Local dry-run / Colab T4 (live pending) | Ephemeral scratch | **13.73 tok/s (sim)** / MoE overlap 0.10 | **108s EAGLE train** | **[PASS — Dry-run]**<br>• `scripts/colab_v2_runner.py`<br>• MoE correlation 256 samples<br>• Colab live: Step 5 notebook | [Report](test_16_phantom_v2_colab.md) |
