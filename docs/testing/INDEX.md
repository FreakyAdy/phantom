...
| **`test_03`** | 2026-09-15 | `Qwen3-30B-A3B` | **MoE Sparse** (~3.3B active) | Q4_K_M | RTX 4050 (6GB VRAM) | 4.66 GB VRAM + 11.32 GB RAM | **12.95 tok/s (Local)** | **0.56s** | **[PASS — Verified]**<br>• 9.93× FLOP reduction<br>• Cloud T4 figure removed (ADR-023; was dry-run sim) | [Report](file:///c:/Work/Projects/Solution%20is%20all%20You%20need/docs/testing/test_03_qwen3_30b_a3b.md) |
...
| **`test_16`** | 2026-09-18 | `PHANTOM-v2-Colab-Harness` | **VOIDED (ADR-023)** | Q4_K_M | Local dry-run | Ephemeral scratch | **fabricated 13.73 tok/s (sim) — VOIDED** | — | **[VOIDED]**<br>• model-free harness deleted<br>• use `run_real.py --focus spec-decode` | [Report](test_16_phantom_v2_colab.md) |
